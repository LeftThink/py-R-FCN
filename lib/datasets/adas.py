...
class adas(imdb):
    ...
    def _do_python_eval(self, output_dir = 'output'):
        ...
        aps = []
        # The PASCAL ADAS metric changed in 2010
        #use_07_metric = True if int(self._year) < 2010 else False
        #print 'ADAS07 metric? ' + ('Yes' if use_07_metric else 'No')
...
if __name__ == '__main__':
    from datasets.pascal_adas import pascal_adas
    d = pascal_adas('trainval', '2007')
    res = d.roidb
