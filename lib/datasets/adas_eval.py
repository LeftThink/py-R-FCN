...
def adas_ap(rec, prec, use_07_metric=False):
    ...
    Compute ADAS AP given precision and recall.
    If use_07_metric is true, uses the
    ADAS 07 11 point method (default:False).
    """
    if use_07_metric:
        # 11 point metric
        ap = 0.
...
def adas_eval(detpath,
    ...
    Top level function that does the PASCAL ADAS evaluation.
    ...
    [use_07_metric]: Whether to use ADAS07's 11 point AP computation
        (default False)
    """
